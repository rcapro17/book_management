...
SECRET_KEY = 'django-insecure-%e5ix3b8+incber@^&_7m)p8jxtvc_w$b5px#x1k@@-ji8p+)r'
...
# Optionally, you may want to specify where to look for static files during development
STATICFILES_DIRS = [
    # Adjust the path to your static folder
